...
class Habit(models.Model):
    ...
    time_action = models.TimeField(
        auto_now_add=False, auto_now=False, verbose_name="Время (когда выполнить)"
    )
